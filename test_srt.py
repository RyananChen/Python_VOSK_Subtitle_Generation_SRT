...
# 如果要更改中文模型，写为model_path = os.path.join(script_dir, "model_cn")
...
model_name1 = "vosk-model-en-us-librispeech-0.2"
lang1 = "en-us"
...
# 根据检查结果执行不同语句，如果有下载的，就用下载的，如果没有下载的，就用我们自己配置的model
if files_exist:
    # 执行语句1
    print("##############################################################") 
    print("##############################################################") 
    ...
    print("2. 确保你的模型文件路径没有中文和特殊符号，并和.py脚本在同一路径，命名为model") 
    print("##############################################################") 
    print("##############################################################") 
